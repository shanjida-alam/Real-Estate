...
public class Show_Client_List extends javax.swing.JFrame {
    Connection con = null;
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Client_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_Client_List().setVisible(true);
            }
        });
    }
